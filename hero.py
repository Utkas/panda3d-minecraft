class Hero():
    ...
    def accept_events(self):
        base.accept('x', self.turn_left)
        base.accept('x' + '-repeat', self.turn_left)
        base.accept('c', self.turn_right)
        base.accept('c' + '-repeat', self.turn_right)
        ...
        base.accept('[', self.land.loadMap)
        base.accept(']', self.land.saveMap)